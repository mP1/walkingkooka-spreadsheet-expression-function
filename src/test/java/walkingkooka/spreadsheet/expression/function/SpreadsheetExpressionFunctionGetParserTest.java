...
public final class SpreadsheetExpressionFunctionGetParserTest extends SpreadsheetExpressionFunctionTestCase<SpreadsheetExpressionFunctionGetParser, SpreadsheetParserSelector> {
    ...
    @Override
    public SpreadsheetExpressionFunctionGetParser createBiFunction() {
