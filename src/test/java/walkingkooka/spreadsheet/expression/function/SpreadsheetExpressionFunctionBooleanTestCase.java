...
public abstract class SpreadsheetExpressionFunctionBooleanTestCase<F extends SpreadsheetExpressionFunctionBoolean> extends SpreadsheetExpressionFunctionTestCase<F, Boolean> {

    SpreadsheetExpressionFunctionBooleanTestCase() {
        super();
    }
