...
public final class SpreadsheetExpressionFunctionGetDecimalNumberSymbolsTest extends SpreadsheetExpressionFunctionTestCase<SpreadsheetExpressionFunctionGetDecimalNumberSymbols, DecimalNumberSymbols> {
    ...
    @Override
    public SpreadsheetExpressionFunctionGetDecimalNumberSymbols createBiFunction() {
