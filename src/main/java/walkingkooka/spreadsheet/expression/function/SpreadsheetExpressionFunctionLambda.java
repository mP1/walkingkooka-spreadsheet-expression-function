 ...
 * A lambda function.
 */
final class SpreadsheetExpressionFunctionLambda extends SpreadsheetExpressionFunction<ExpressionFunction<?, SpreadsheetExpressionEvaluationContext>> {

    /**
     * Singleton
     */
    final static SpreadsheetExpressionFunctionLambda INSTANCE = new SpreadsheetExpressionFunctionLambda();

    private SpreadsheetExpressionFunctionLambda() {
        super("lambda");
    }
