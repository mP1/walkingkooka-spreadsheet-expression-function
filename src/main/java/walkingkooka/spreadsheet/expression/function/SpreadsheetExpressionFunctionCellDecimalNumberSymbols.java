 ...
 */
final class SpreadsheetExpressionFunctionCellDecimalNumberSymbols extends SpreadsheetExpressionFunctionCell<DecimalNumberSymbols> {

    /**
     * Singleton
     */
    final static SpreadsheetExpressionFunctionCellDecimalNumberSymbols INSTANCE = new SpreadsheetExpressionFunctionCellDecimalNumberSymbols();

    private SpreadsheetExpressionFunctionCellDecimalNumberSymbols() {
        super("cellDecimalNumberSymbols");
    }
