 ...
 */
final class SpreadsheetExpressionFunctionCellValidator extends SpreadsheetExpressionFunctionCell<ValidatorSelector> {

    /**
     * Singleton
     */
    final static SpreadsheetExpressionFunctionCellValidator INSTANCE = new SpreadsheetExpressionFunctionCellValidator();

    private SpreadsheetExpressionFunctionCellValidator() {
        super("cellValidator");
    }
