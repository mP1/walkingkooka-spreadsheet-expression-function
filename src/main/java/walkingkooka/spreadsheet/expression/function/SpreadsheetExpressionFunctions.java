...
public final class SpreadsheetExpressionFunctions implements PublicStaticHelper {
    ...
    /**
     * {@see JsonNodeExpressionFunctions#jsonPointerEval}
     */
    public static ExpressionFunction<JsonNode, SpreadsheetExpressionEvaluationContext> jsonPointerEval() {
        return fixName(
            JsonNodeExpressionFunctions.jsonPointerEval()
        );
    }
     ...
     */
    public static ExpressionFunction<JsonSelector, SpreadsheetExpressionEvaluationContext> jsonSelector() {
        return fixName(
            JsonNodeExpressionFunctions.jsonSelector()
        );
    }
    ...
    /**
     * {@link ExpressionFunctions#error}
     */
    public static ExpressionFunction<Void, SpreadsheetExpressionEvaluationContext> logError() {
        return fixName(
            ExpressionFunctions.error()
        ).setName(
    ...
    /**
     * {@link ExpressionFunctions#info}
     */
    public static ExpressionFunction<Void, SpreadsheetExpressionEvaluationContext> logInfo() {
        return fixName(
            ExpressionFunctions.info()
        ).setName(
    ...
    /**
     * {@link ExpressionFunctions#warn}
     */
    public static ExpressionFunction<Void, SpreadsheetExpressionEvaluationContext> logWarn() {
        return fixName(
            ExpressionFunctions.warn()
        ).setName(
            functionName("logWarn")
        );
    }
    ...
    /**
     * {@see TreeTextExpressionFunctions#margin}
     */
    public static ExpressionFunction<Margin, SpreadsheetExpressionEvaluationContext> margin() {
        return fixName(
            TreeTextExpressionFunctions.margin()
        );
    }
     ...
     */
    public static ExpressionFunction<Object, SpreadsheetExpressionEvaluationContext> readStorage() {
        return fixName(
            StorageExpressionFunctions.readStorage()
        );
    }
    ...
    /**
     * {@see TreeTextExpressionFunctions#styleReplaceIf}
     */
    public static ExpressionFunction<Styleable, SpreadsheetExpressionEvaluationContext> styleReplaceIf() {
        return fixName(
            TreeTextExpressionFunctions.styleReplaceIf()
        );
    }
