...
final class SpreadsheetExpressionFunctionCellValueType extends SpreadsheetExpressionFunctionCell<Object> {
     ...
     * Singleton
     */
    final static SpreadsheetExpressionFunctionCellValueType INSTANCE = new SpreadsheetExpressionFunctionCellValueType();

    private SpreadsheetExpressionFunctionCellValueType() {
        super("cellValueType");
    }
