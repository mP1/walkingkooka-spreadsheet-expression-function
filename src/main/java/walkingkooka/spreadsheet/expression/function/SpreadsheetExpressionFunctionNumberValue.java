 ...
 */
final class SpreadsheetExpressionFunctionNumberValue extends SpreadsheetExpressionFunctionNumber {

    /**
     * Singleton
     */
    final static SpreadsheetExpressionFunctionNumberValue INSTANCE = new SpreadsheetExpressionFunctionNumberValue();

    private SpreadsheetExpressionFunctionNumberValue() {
        super("numberValue");
